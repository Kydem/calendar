...
},{}],"C:/Users/kydem/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"C:/Users/kydem/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"C:/Users/kydem/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"app.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"C:/Users/kydem/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/dayjs/plugin/weekday.js":[function(require,module,exports) {
var define;
...
var initialYear = (0, _dayjs.default)().format("YYYY");
var initialMonth = (0, _dayjs.default)().format("M");
var weekdays = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];
var today = (0, _dayjs.default)().format("YYYY-MM-DD");
var selectedMonth = (0, _dayjs.default)(new Date(initialYear, initialMonth - 1, 1));
...
function createCalendar() {
  var year = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialYear;
  var month = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : initialMonth;
  ...
  currentMonthDays = createDaysOfMonth(year, month, (0, _dayjs.default)("".concat(year, "-").concat(month, "-01")).daysInMonth());
...
function createDaysOfMonth(year, month) {
  ...
  return _toConsumableArray(Array(getDaysOfMonth(year, month))).map(function (day, index) {
    return {
...
function createDaysForPreviousMonth(year, month) {
  ...
  var firstDayOfTheMonth = getWeekday(currentMonthDays[0].date);
  ...
  var visibleDaysFromPrevMonth = firstDayOfTheMonth ? firstDayOfTheMonth - 1 : 6;
  var lastSundayOfPrevMonth = (0, _dayjs.default)(currentMonthDays[0].date).subtract(visibleDaysFromPrevMonth, "day").date();
  ...
  return _toConsumableArray(Array(visibleDaysFromPrevMonth)).map(function (day, index) {
    return {
      date: (0, _dayjs.default)("".concat(previousMonth.year(), "-").concat(previousMonth.month() + 1, "-").concat(lastSundayOfPrevMonth + index)).format("YYYY-MM-DD"),
...
function createDaysforNextMonth(year, month) {
  ...
  var lastDayOfMonth = getWeekday("".concat(year, "-").concat(month, "-").concat(currentMonthDays.length));
  // Conditional to determine dates shown from the next month
  var visibleDaysFromNextMonth = lastDayOfMonth ? 7 - lastDayOfMonth : lastDayOfMonth;

  // same process as PREVIOUS month, but reversed (Number method used to simplify math)
  return _toConsumableArray(Array(visibleDaysFromNextMonth)).at(function (day, index) {
    return {
      date: (0, _dayjs.default)("".concat(year, "-").concat(Number(month) + 1, "-").concat(index + 1)).format("YYYY-MM-DAY"),
      dayOfMonth: index + 1,
      isCurrentMonth: false
    };
  });
...
function initMonthSelectors() {
  document.getElementById("previous-month-selector").addEventListener("click", function () {
    ...
    createCalendar(selectedMonth.fomrat("YYYY"), selectedMonth.format("M"));
  });
  document.getElementById("present-month-selector").addEventListener("click", function () {
    selectedMonth = (0, _dayjs.default)(new Date(initialYear, initialMonth - 1, 1));
    createCalendar(selectedMonth.fomrat("YYYY"), selectedMonth.format("M"));
  });
...
},{"dayjs":"../node_modules/dayjs/dayjs.min.js","./app.css":"app.css","dayjs/plugin/weekday":"../node_modules/dayjs/plugin/weekday.js","dayjs/plugin/weekOfYear":"../node_modules/dayjs/plugin/weekOfYear.js"}],"C:/Users/kydem/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/kydem/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
